...
# Automated test script for the solution
...
if ansible -i inventories/apache2.yml all -m ping > /dev/null 2>&1; then
    print_success "Apache servers connection OK"
else
