...
# Check mode (dry-run, does nothing)
...
# Check result: "changed=0" = idempotent ✅
```
...
### Scenario 3: Adding a new server
```bash
...
📝 **Note**: All these commands must be run from the `correction-english/` folder
