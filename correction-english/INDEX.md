# 📚 Solution index - Ansible Group Exercise

## 🎯 Overview

This complete solution illustrates a professional Ansible infrastructure with 4 servers (2 Apache2 + 2 Nginx), managed by dedicated playbooks, roles, inventories, and templates.
...
4. **Check**: `COMMANDS.md` for advanced commands
...
**Result**: Complete operational infrastructure in 1 minute!
...
- **group_vars/all.yml**: Variables common to all servers
...
### ✅ Level 3: Advanced
- [x] Idempotence (re-runs without side effects)
- [x] Separation of concerns (Clean Architecture)
- [x] Infrastructure as Code
- [x] Docker as Ansible target
...
**A:** Allows deploying Apache and Nginx independently. In production, you might have separate environments (dev, staging, prod).

### Q: Why roles and not just tasks?
**A:** Roles enable reuse, organization, and code portability.
...
### Exercise 5: Check and diff mode
1. Modify a variable
...
# Tests
./test.sh                               # Complete test
ansible -i inventories/apache2.yml all -m ping    # Connection test

# Debug
docker exec -it apache-server-1 bash    # Enter container
...
- [ ] Explain the difference between playbook and role
...
This solution represents a **professional Ansible architecture** that you can use as a base for your own projects.
