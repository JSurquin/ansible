...
### Voici le sommaire de cette formation sur Docker et Ansible:
...
<Link to="docker-scout">🛡️ Docker Scout</Link>
<Link to="docker-model-runner">🚀 Docker Model Runner</Link>
</div>
::right::
...
<Link to="kubernetes">🎉 Introduction à Kubernetes</Link>
<Link to="kubernetes-local">🌐 Kubernetes local multi-node</Link>
<Link to="ansible-intro">🤖 Introduction à Ansible</Link>
<Link to="ansible-docker">🔧 Ansible et Docker</Link>
<Link to="mini-blog">📝 Projet Mini-Blog</Link>
<Link to="mini-blog-exercices">📚 Exercices Mini-Blog</Link>
</div> 