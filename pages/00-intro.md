...
- **Expertise** : DevOps, Infrastructure as Code, Container Technologies
- **Contenu** : <a href="https://www.youtube.com/channel/jimmylansrq"> <logos-youtube-icon mr-1 /> jimmylansrq </a>
- **Portfolio** : <a href="https://jimmylan.fr"> jimmylan.fr </a>

### Expérience

- **10+ années** d'expérience en infrastructure et DevOps
- **Consultant** pour de nombreuses entreprises françaises
- **Formateur** spécialisé en technologies de conteneurisation
...
- **Linux/Unix** : Notions de base en ligne de commande
- **Développement** : Concepts de base (peu importe le langage)
- **Réseau** : Compréhension basique des concepts réseau
- **YAML** : Syntaxe de base (sera approfondie durant la formation)
